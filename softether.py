...
if choice == 1:
   ...
   time.sleep(1)
   os.system('https://www.softether-download.com/files/softether/v4.34-9745-rtm-2020.04.05-tree/Linux/SoftEther_VPN_Server/32bit_-_Intel_x86/softether-vpnserver-v4.34-9745-rtm-2020.04.05-linux-x86-32bit.tar.gz')
...
if choice == 2:
   ...
   print('\033[92mDownloading Softether Package')
   time.sleep(1)
   os.system('wget https://raw.githubusercontent.com/https://github.com/BeatZ1337/BeatZ-Softether-Auto-Install/master/beaters2.sh --no-check-certificate mv beaters2.sh')
   os.system('cd vpnserver')
   os.system('clear')
   print('\033[95mPress \03396m1 \03395m 3 Times To Continue')
   time.sleep(1)
