...
if choice == 1:
   ...
   time.sleep(1)
   os.system('wget https://www.softether-download.com/files/softether/v4.34-9745-rtm-2020.04.05-tree/Linux/SoftEther_VPN_Server/32bit_-_Intel_x86/softether-vpnserver-v4.34-9745-rtm-2020.04.05-linux-x86-32bit.tar.gz')
   ...
   os.system('wget wget https://raw.githubusercontent.com/Anonghost720/SoftEther-Autoinstal-By-ANonghost720/master/vpn-server.sh --no-check-certificate mv vpn-server.sh /etc/init.d/vpnserver')
