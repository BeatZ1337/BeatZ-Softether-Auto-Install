...
if choice == 1:
   ...
   time.sleep(1)
   os.system('wget http://www.softether-download.com/files/softether/v4.32-9731-beta-2020.01.01-tree/Linux/SoftEther_VPN_Server/64bit_-_Intel_x64_or_AMD64/softether-vpnserver-v4.32-9731-beta-2020.01.01-linux-x64-64bit.tar.gztar zxf softether-vpnserver-v4.32-9731-beta-2020.01.01-linux-x64-64bit.tar.gz')
   ...
   os.system('rm -rf softether-vpnserver-v4.32-9731-beta-2020.01.01-linux-x64-64bit.tar.gz')
   os.system('cd /usr/local/vpnserver')
   os.system('chmod 600 *')
   os.system('chmod 700 vpncmd')
   os.system('chmod 700 vpnserver')
   os.system('wget https://raw.githubusercontent.com/Anonghost720/SoftEther-Autoinstal-Ubuntu-Debian/master/vpn-server.sh --no-check-certificate mv vpn-server.sh /etc/init.d/vpnserver')
...
if choice == 2:
   ...
   print('\033[92mDownloading Softether Package')
   time.sleep(1)
   os.system('wget http://www.softether-download.com/files/softether/v4.32-9731-beta-2020.01.01-tree/Linux/SoftEther_VPN_Server/64bit_-_Intel_x64_or_AMD64/softether-vpnserver-v4.32-9731-beta-2020.01.01-linux-x64-64bit.tar.gz tar zxf softether-vpnserver-v4.32-9731-beta-2020.01.01-linux-x64-64bit.tar.gz')
   os.system('cd vpnserver')
   os.system('clear')
   print('\033[95mPress \03396m1 \03395m 3 Times To Continue')
   time.sleep(1)
   ...
   os.system('chmod 700 vpncmd')
   os.system('chmod 700 vpnserver')
   os.system('wget https://raw.githubusercontent.com/Anonghost720/SoftEther-Autoinstal-By-ANonghost720/master/vpn-server.sh --no-check-certificate mv vpn-server.sh /etc/init.d/vpnserver')
   os.system('cd /etc/init.d/')
   os.system('chmod 755 vpnserver')
